...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_UTILITY_MOJO_LEDGER_CLIENT_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_UTILITY_MOJO_LEDGER_CLIENT_H_
...
class MojoLedgerClient : public ledger::LedgerClient {
 public:
  MojoLedgerClient();
  ~MojoLedgerClient() override;

  static MojoLedgerClient* Create();
 ...
 private:
  ...
  rewards::mojom::LedgerClientPtr ledger_client_;
};

} // namespace rewards

#endif // BRAVE_COMPONENTS_BRAVE_REWARDS_UTILITY_MOJO_LEDGER_CLIENT_H_
